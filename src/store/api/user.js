...
export const viewPerfil = () => axios.get(url + '/perfil', getHeaders());

export const putPerfil = (userData) =>
  axios.put(url + '/perfil', userData, getHeaders());

export const putPerfilFoto = (id, userData) =>
  axios.put(url + '/perfil-img/users/:id', userData, getHeaders());
